# Carnivores 2 - Modder's Engine v1.11 (Modernized v1.1.7)

> **Original release:** 2000 (Action Forms)
> **Base:** Carnivores 2 Modder's Engine v1.11 (community revival)
> **Project release:** Modernized v1.1.7 — GitHub `v1.1.7-modernized`
> **ModDB download label:** V4
...
base. **Modernized v1.1.7** identifies this fork's release; **V4** is only
...
Windows executable version resources identify the project release as `1.1.7.0`.
These labels do not change save formats or the upstream engine version.
See [CHANGELOG.md](CHANGELOG.md) for changes since Modernized v1.1.6.
