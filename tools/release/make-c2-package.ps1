...
param(
    [string]$RepoRoot = '',
    [string]$PkgRoot  = '',
    [string]$OpenAlDir = 'E:\Games\CarnivoresLegacy',
    [string]$ShaOut = ''
)
...
$SevenZip  = 'D:\Portable\PortablePlatform\PortableApps\7-ZipPortable\App\7-Zip\7z.exe'
...
$lgpl    = 'D:\Portable\Ghidra\GPL\licenses\LGPL_2.1.txt'
